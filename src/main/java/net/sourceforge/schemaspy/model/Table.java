...
public class Table implements Comparable<Table> {
    ...
    private Connection getConnection(String connectionURL, String user, String password, String driverClass, String driverPath, String db) throws FileNotFoundException, IOException {
        ...
        connectionProps.put("databaseName", db);

        try {
            conn = driver.connect(connectionURL, connectionProps);
            if (conn == null) {
                System.err.println();
    ...
    public void connectForeignKeys(Map<String, Table> tables, Pattern excludeIndirectColumns, Pattern excludeColumns) throws SQLException {
        ...
        try {
            ...
            conn = getConnection(url
                    ...
                    , this.properties.getProperty("db")
            );
